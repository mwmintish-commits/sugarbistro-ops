...
const SECTIONS = [
  ...
  },
  {
    title: "🏆 獎金與福利",
    items: [
      "季績效獎金：依門市達標率與個人考核發放，發放日須在職",
      "三節獎金：依公司年度盈餘酌發，到職滿 3 個月起按比例",
      "年終獎金：依年度獲利與個人績效核發，非每年保證",
      "聚餐、旅遊、教育訓練：依年度預算辦理，得調整或停辦",
      "以上均屬恩惠性給與，非經常性薪資，不計入平均工資、退休金、資遣費基數",
      "公司保留調整、暫停或終止之裁量權；過往發放不構成請求權",
    ],
  },
];
